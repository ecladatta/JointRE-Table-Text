...
def main(args):
    ...
    if args.base_model == 'mt0-xl':
        model = AutoModelForSeq2SeqLM.from_pretrained(
            model_name,
            trust_remote_code=True,
            device_map= 'auto'
        )
        print("Model was charged correctly!")
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_model", required=True, type=str, choices=['chatglm2','llama3Inst70B','llama31Inst70B','llama31Inst8B', 'llama2','llama3','llama31', 'DeepSeek-R1-Distill-Llama-8B','DeepSeek-R1', 'falcon','mt0-xl', 'internlm', 'qwen', 'mpt', 'bloom','bloomberg'])
