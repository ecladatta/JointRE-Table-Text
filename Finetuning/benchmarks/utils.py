...
lora_module_dict = {
    ...
    'llama31Inst8B': ['q_proj', 'k_proj', 'v_proj'],
...
def parse_model_name(name, from_remote=False):
    ...
    model_paths = {
        ...
        'llama2': ('meta-llama/Llama-2-7b-hf', '/projets/melodi/mettaleb/base_models/Llama-2-7b-chat-hf'),
...
def load_dataset(names, from_remote=False):
    ...
    for name in dataset_names:
        ...
        dataset_path_or_name = ('/users/melodi/mettaleb/data/fingpt-') + dataset_name
