...
lora_module_dict = {
    ...
    'fingpt_glm': ['query_key_value'],
    'falcon': ['query_key_value'],
    'falcon-1b' : ['query_key_value'],
    'bloom': ['query_key_value'],
    'bloomberg':  ['q_proj', 'k_proj', 'v_proj'],
    'internlm': ['q_proj', 'k_proj', 'v_proj'],
    'llama2': ['q_proj', 'k_proj', 'v_proj'],
    'llama3': ['q_proj', 'k_proj', 'v_proj'],
    'llama31': ['q_proj', 'k_proj', 'v_proj'],
    'llama31Inst8B': ['q_proj', 'k_proj', 'v_proj','o_proj'],
    'llama3Inst70B' : ['q_proj', 'k_proj', 'v_proj'],
    'llama31Inst70B' : ['q_proj', 'k_proj', 'v_proj'],
    'llama2-13b': ['q_proj', 'k_proj', 'v_proj'],
    'llama2-13b-nr': ['q_proj', 'k_proj', 'v_proj'],
    'DeepSeek-R1-Distill-Llama-8B': ['q_proj', 'k_proj', 'v_proj'],
    'DeepSeek-R1': ['q_proj', 'k_proj', 'v_proj'],
    'mt0-xl' : ['q', 'v'],
    'qwen': ["c_attn"],
    'mpt': ['Wqkv'],
    'baichuan': ['q_proj', 'k_proj', 'v_proj'],
    'DeciLM-7B': ['q_proj', 'k_proj', 'v_proj'],
    'flan-t5-base' : ['q_proj', 'k_proj', 'v_proj']
}
...
def parse_model_name(name, from_remote=False):
    ...
    model_paths = {
        ...
        'llama2': ('meta-llama/Llama-2-7b-chat-hf', '/projects/melodi/mettaleb/base_models/Llama-2-7b-chat-hf'),
        'llama2-13b': ('meta-llama/Llama-2-13b-hf', '/projets/melodi/mettaleb/base_models/Llama-2-13b-hf'),
        'llama2-13b-nr': ('NousResearch/Llama-2-13b-hf', '/projets/melodi/mettaleb/base_models/Llama-2-13b-hf'),
        'llama3': ('meta-llama/Meta-Llama-3-8B', '/projects/melodi/mettaleb/base_models/Meta-Llama-3-8B'),
        'llama31': ('meta-llama/Meta-Llama-3-8B', '/projects/melodi/mettaleb/base_models/Meta-Llama-3.1-8B'),
        'llama31Inst8B': ('meta-llama/Llama-3.1-8B-Instruct', '/projects/melodi/mettaleb/base_models/Llama-3.1-8B-Instruct'),
        'llama3Inst70B': ('meta-llama/Meta-Llama-3-70B-Instruct', '/projects/melodi/mettaleb/base_models/Llama-3-70B-Instruct'),
        'llama31Inst70B': ('meta-llama/Llama-3.1-70B-Instruct', '/projects/melodi/mettaleb/base_models/Llama-3.1-70B-Instruct'),
        'DeepSeek-R1-Distill-Llama-8B': ('deepseek-ai/DeepSeek-R1-Distill-Llama-8B', '/projects/melodi/mettaleb/base_models/DeepSeek-R1-Distill-Llama-8B'),
        'DeepSeek-R1': ('deepseek-ai/DeepSeek-R1', '/projects/melodi/mettaleb/base_models/DeepSeek-R1'),
        'mt0-xl': ('bigscience/mt0-xl', '/projects/melodi/mettaleb/base_models/mt0-xl'),
        'falcon': ('tiiuae/falcon-7b', 'base_models/falcon-7b'),
        'falcon-1b': ('euclaise/falcon_1b_stage2', 'base_models/falcon-1b'),
        ...
        'bloom': ('bigscience/bloom-7b1', '/projets/melodi/mettaleb/base_models/bloom-7b1'),
        'bloomberg': ('bloomberg/KeyBART', 'base_models/bloomberg'),
        'DeciLM-7B': ('Deci/DeciLM-7B', 'base_models/bloomberg'),
        'fingpt_glm': ("FinGPT/fingpt-mt_chatglm2-6b_lora", 'base_models/fingpt-mt_chatglm2-6b_lora'),
        'flan-t5-base' : ("google/flan-t5-base", "base_models/flan-t5-base")
    }
...
def load_dataset(names, from_remote=False):
    ...
    for name in dataset_names:
        ...
        dataset_path_or_name = ('/projects/melodi/mettaleb/FinGPT/fingpt/FinGPT_Benchmark/data/fingpt-') + dataset_name
        ...
        # Load the dataset
        try:
            tmp_dataset = datasets.load_from_disk(dataset_path_or_name)
